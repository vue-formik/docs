<template>
  <section>
    ...
    <article class="!my-6">
      <h4 class="flex items-center gap-2"><InfoIcon /> Key Points:</h4>
    ...
    <article class="!my-6">
      <h4 class="flex items-center gap-2"><InfoIcon /> How Debouncing Works:</h4>
      <ul class="list-disc ml-6">
        <li>
    ...
    <article class="!my-8 border-l-4 border-blue-500 bg-blue-50/10 p-4">
      <h4 class="flex items-center gap-2"><InfoIcon /> Performance Tip:</h4>
      <p>
